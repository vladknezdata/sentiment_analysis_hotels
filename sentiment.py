...
# hotelDf.columns=['id','filePath','hotelName','review','ratingScore','groundTruth']
    ...
    objects = ratingByHotel['hotelName']
    y_pos = np.arange(len(objects))
    performance = ratingByHotel['ratingScore']

    plt.barh(y_pos, performance, align='center', alpha=0.5, color='orange')
    plt.yticks(y_pos, objects)
    plt.yticks(fontsize=5, rotation=5)
    plt.xlabel('Rating Score')
    plt.title('NYC Hotel Names - RATING')
    plt.savefig('static/NYCHotelRating')
    plt.clf()
    # plt.show()

    objects_v = vaderByHotel['hotelName']
    v_pos = np.arange(len(objects_v))
    performance_v = vaderByHotel['vaderScore']

    plt.barh(v_pos, performance_v, align='center', alpha=0.5)
    plt.yticks(v_pos, objects_v)
    plt.yticks(fontsize=5, rotation=5)
    plt.xlabel('VADER Score')
    plt.title('NYC Hotel Names - VADER')
    plt.savefig('static/NYCHotelVaderScore')    
    # with open('static/NYCHotelRating.jpg', 'w') as outfile:
    #     outfile.write(ratingByHotel.to_jpg())
    
    # imgkit.from_file('static/NYCHotelRating.html', 'NYCHotelRating.jpg')

    # with open('static/NYCHotelRating.html') as f:
    #     imgkit.from_file(f, 'NYCHotelRating.jpg')
    ...
    for ax in g.axes.flat:
        ...
        ax.set_xticklabels(labels, rotation=7) # set new labels
    plt.savefig('static/NYCboxRating')
    plt.clf()
    ...
    for ax in g.axes.flat:
        labels = ax.get_xticklabels() # get x labels
        ax.set_xticklabels(labels, rotation=7) # set new labels
    plt.savefig('static/NYCboxVader')
    plt.clf()
...
# hotelDf.columns=['id','filePath','hotelName','review','ratingScore','groundTruth']
    ...
    # hotelDf['review'] = hotelDf['review'].str.replace(j,"")
    # hotelDf
    locationName = ['faneuil', 'Faneuil','Hall', 'hall', 'Quincy', 'quincy','market','Market',
       'building', 'Building', 'north', 'North', 'end', 'End', 'freedom', 'Freedom', 'Trail',
               'trail', 'quot', 'Quot', 'ano','frily','Frily' ,'Ano', 'fenway','Fenway','ian','Ian']
    ...
    plt.xlabel('Rating Score')
    plt.title('NYC Hotel Names - RATING')
    plt.savefig('static/BOSHotelRating')
    plt.clf()
    # plt.show()
    ...
    plt.xlabel('VADER Score')
    plt.title('NYC Hotel Names - VADER')
    plt.savefig('static/BOSHotelVaderScore')    
    # with open('static/NYCHotelRating.jpg', 'w') as outfile:
    #     outfile.write(ratingByHotel.to_jpg())
    ...
    pmiPos_unigram.head(10).plot.bar(rot=40, color='b', fontsize=7,
                                    title='Top 10 words in Positive Reviews based on PMI scores')
    plt.savefig("static/BOStop10PosUni")
    plt.clf()

    pmiNeg_unigram.head(10).plot.bar(rot=40, color='r', fontsize=7,
                                    title='Top 10 words in Negative Reviews based on PMI scores')
    plt.savefig("static/BOStop10NegUni")
    plt.clf()
   
    pmiPos_bigram.head(10).plot.bar(rot=40, color='b', fontsize=7,
                                    title='Top 10 words in Positive Reviews based on PMI scores')
    plt.savefig("static/BOStop10PosBi")
    plt.clf()

    pmiNeg_bigram.head(10).plot.bar(rot=40, color='r', fontsize=7,
                                    title='Top 10 words in Negative Reviews based on PMI scores')
    plt.savefig("static/BOStop10NegBi")
    plt.clf()

    plt.xlabel('Rating Score')
    hotelDf['ratingScore'].plot(kind='hist', title='Histogram - Rating Scores',
                                bins=np.arange(1,7)-0.5)
    plt.savefig("static/BOSratingScore")
    plt.clf()

    plt.xlabel('Vader Sentiment Score')
    hotelDf['vaderScore'].plot(kind='hist', title='Histogram - Vader Scores', 
                            xticks=[-1.0, -0.5, 0.0, 0.5, 1.0])
    plt.savefig("static/BOSvaderScore")
    plt.clf()
    ...
    for ax in g.axes.flat:
        labels = ax.get_xticklabels() # get x labels
        ax.set_xticklabels(labels, rotation=7) # set new labels
    plt.savefig('static/BOSboxRating')
    plt.clf()
    ...
    for ax in g.axes.flat:
        labels = ax.get_xticklabels() # get x labels
        ax.set_xticklabels(labels, rotation=7) # set new labels
    plt.savefig('static/BOSboxVader')
    plt.clf()
...
# hotelDf.columns=['id','filePath','hotelName','review','ratingScore','groundTruth']
    ...
    df_filter = pd.read_csv('sanf.csv')
# hotelDf.columns=['id','filePath','hotelName','review','ratingScore','groundTruth']
    df_filter.columns=['filePath','hotelName','review','ratingScore','groundTruth']
    df_filter.head()
    ...
    plt.xlabel('Rating Score')
    plt.title('NYC Hotel Names - RATING')
    plt.savefig('static/SFRHotelRating')
    plt.clf()
    # plt.show()
    ...
    plt.xlabel('VADER Score')
    plt.title('NYC Hotel Names - VADER')
    plt.savefig('static/SFRHotelVaderScore')    
    # with open('static/NYCHotelRating.jpg', 'w') as outfile:
    #     outfile.write(ratingByHotel.to_jpg())
    ...
    pmiPos_unigram.head(10).plot.bar(rot=40, color='b', fontsize=7,
                                    title='Top 10 words in Positive Reviews based on PMI scores')
    plt.savefig("static/SFRtop10PosUni")
    plt.clf()

    pmiNeg_unigram.head(10).plot.bar(rot=40, color='r', fontsize=7,
                                    title='Top 10 words in Negative Reviews based on PMI scores')
    plt.savefig("static/SFRtop10NegUni")
    plt.clf()
   
    pmiPos_bigram.head(10).plot.bar(rot=40, color='b', fontsize=7,
                                    title='Top 10 words in Positive Reviews based on PMI scores')
    plt.savefig("static/SFRtop10PosBi")
    plt.clf()

    pmiNeg_bigram.head(10).plot.bar(rot=40, color='r', fontsize=7,
                                    title='Top 10 words in Negative Reviews based on PMI scores')
    plt.savefig("static/SFRtop10NegBi")
    plt.clf()

    plt.xlabel('Rating Score')
    hotelDf['ratingScore'].plot(kind='hist', title='Histogram - Rating Scores',
                                bins=np.arange(1,7)-0.5)
    plt.savefig("static/SFRratingScore")
    plt.clf()

    plt.xlabel('Vader Sentiment Score')
    hotelDf['vaderScore'].plot(kind='hist', title='Histogram - Vader Scores', 
                            xticks=[-1.0, -0.5, 0.0, 0.5, 1.0])
    plt.savefig("static/SFRvaderScore")
    plt.clf()
    ...
    for ax in g.axes.flat:
        labels = ax.get_xticklabels() # get x labels
        ax.set_xticklabels(labels, rotation=7) # set new labels
    plt.savefig('static/SFRboxRating')
    plt.clf()
    ...
    for ax in g.axes.flat:
        labels = ax.get_xticklabels() # get x labels
        ax.set_xticklabels(labels, rotation=7) # set new labels
    plt.savefig('static/SFRboxVader')
    plt.clf()
